...
// Para números
export function MaxNumberField(option: { message: string, maxValue: number }, validationOptions?: ValidationOptions) {
    return function (object: Object, propertyName: string) {
        registerDecorator({
            name: 'MaxNumberField',
            target: object.constructor,
...
// Para strings
export function MaxLengthField(option: { message: string, maxLength: number }, validationOptions?: ValidationOptions) {
    return function (object: Object, propertyName: string) {
        registerDecorator({
            name: 'MaxLengthField',
            target: object.constructor,
            propertyName,
            options: {
                message: `${option.message} no puede tener más de ${option.maxLength} caracteres`,
                ...validationOptions,
            },
            validator: {
                validate(value: any) {
                    return typeof value === 'string' && value.length <= option.maxLength;
                },
            },
        });
    };
